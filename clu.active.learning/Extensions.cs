...
namespace clu.active.learning
{
    ...
    There are almost 15,000 public types in the .NET Framework. Although not all of these 
    are extendable classes, many of them are. When you want to develop a class, in many 
    cases there is a built-in .NET Framework class that can provide a foundation for your 
    code. 

    There are two key advantages to creating a class that inherits from a .NET Framework 
    class, rather than developing a class from scratch: 

        • Reduced development time. By inheriting from an existing class, you reduce the 
        amount of logic that you have to create yourself. 
        • Standardized functionality. Just like implementing an interface, inheriting from 
        a standard base class means that your class will work in a standardized way. You 
    ...
    The rules of inheritance apply to built-in .NET Framework classes in the same way they 
    apply to custom classes: 

        • You can create a class that derives from a .NET Framework class, providing that 
                ...
                Console.WriteLine("** Using Custom Exceptions");
                {
                    ...
                    error conditions. For example: 
                        ...
                        • If you invoke a method with a null argument value, and the method cannot 
                          handle null argument values, the method will throw an ArgumentNullException.
                        • If you attempt to divide a numerical value by zero, the runtime will throw a 
                          DivideByZeroException.
                        • If you attempt to retrieve an indexed item from a collection, and the index 
                          it outside the bounds of the collection, the indexer will throw an 
                    ...
                    specific error conditions in specific ways by catching a specific exception type. 
                    The exception type is not designed to communicate the precise details of the problem. 
                    All exception classes include a message property for this purpose. Therefore, you 
                    should not create a custom exception class just to communicate the nature of an error 
                    condition. Create a custom exception class only if you need to handle that error 
                    ...
                    • The Message property enables you to provide more information about what happened as 
                      a text string. 
                    • The InnerException property enables you to identify another Exception instance that 
                      caused the current instance. 
                    • The Source property enables you to specify the item or application that caused the 
                      error condition. 
                    • The Data property enables you to provide more information about the error condition 
                    as key-value pairs.
