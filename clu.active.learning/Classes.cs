    ...
    */
    public static class Classes
    {
        ...
        public class DrinksMachine // public, internal (default), private
        {
            ...
            {
                // This is a default constructor (it has no params). Empty public default constructor is automatically 
                // added by the Visual C# compiler if not included in class.
                this.Age = 0;
            }
        ...
        Create a class purely to encapsulate some useful functionality, rather than to represent an instance of 
        anything.   

        Use a static class when it would not make sense to instantiate a class in order to use methods or properties, 
        to store or retrieve any instance-specific data.
        ...
        */
        ...
        Non-static classes can include static members. This is useful when some behaviors and characteristics relate to 
        the instance (instance members), while some behaviors and characteristics relate to the type itself (static 
        members). Methods, fields, properties, and events can all be declared static. Static properties are often used 
        to return data that is common to all instances, or to keep track of how many instances of a class have been 
        created. Static methods are often used to provide utilities that relate to the type in some way, such as 
            ...
            Console.WriteLine("* Using Classes");
            {
                Console.WriteLine("** Instantiating a Class");
                {
                    ...
                    Instantiating a Class:
                        ...
                        • An object reference name drinksMachine is created which refers to new DrinksMachine object.
                ...
                Console.WriteLine("** Instantiating a Class by Using Type Inference");
                {
                    ...
                    In some circumstances, type inference can make code easier to read, while in other circumstances it 
                    may make code more confusing.

                    As a general rule, consider using type inference when the type of variable is absolutely clear. It 
                    also clearly helps when applying TDD!
