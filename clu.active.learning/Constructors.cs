...
namespace clu.active.learning
{
    ...
    public class Location
    {
        ...
        // Expression body definition can be used if a constructor can be implemented as a single 
        // statement. The following example defines a Location class whose constructor has a single 
        // string parameter named name. The expression body definition assigns the argument to the 
        // locationName field.
