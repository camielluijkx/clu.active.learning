    ...
    */
    public static class Inheritance
    {
        ...
        public class BeverageWithBaseClassConstructor
        {
            ...
            public BeverageWithBaseClassConstructor(string name, bool isFairTrade, 
                int servingTemp)
            {
        ...
        public class CoffeeCallingBaseClassConstructor : BeverageWithBaseClassConstructor
        {
            ...
            public CoffeeCallingBaseClassConstructor(string name, bool isFairTrade, 
                int servingTemp, string bean, string roast)
